            ...
            <div class="col-lg-8">
              <div
                ...
                :style="`background-image: url(${
                  path + listing.images[index].url
                });`"
                class="blured"
              ></div>
              <div v-else class="imagesblured"></div>
              <div class="displayimages">
                ...
                <div class="arrows">
                  ...
                  <img
                    v-if="listing.images.length > 0"
                    :src="path + listing.images[index].url"
                    :alt="listing.title"
                    height="500"
                    width="500"
                  />
                ...
                <div class="container data">
                  ...
                  <p>
                    <a class="categories" href="#">{{
                      listing.categories.title_en
                    }}</a>
                  </p>
                  <p>
                    <span class="timelocation"
                      >Listed {{ listing.created_at }} in
                  ...
                  >
                    <p>
                      <span class="condition">{{ attribute.attribute }}</span>
                    </p>
                    <p>
                      <span class="new">{{ attribute.value }}</span>
                    </p>
                  </div>
                ...
                <div class="container">
                  <div class="message">
                    <p>
                      ...
                      <span class="txt"> Send message to seller</span>
                    </p>
...
Send message</textarea
                      ...
                      <button
                        type="submit"
                        class="btn btn-primary form-control send"
                      >
                        Send
                      </button>
                    </form>
