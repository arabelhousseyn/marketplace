        ...
        <div class="side">
          ...
          <div class="container">
              ...
              <div class="list">
               ...
               <router-link  v-if="auth != ''"  class="inf" to="/notification"><div class="container info"><i class="fa fa-bell icon"></i> <span>Notifications</span></div></router-link>
               <router-link  v-if="auth != ''" class="inf" to="/inbox"><div class="container info"><i class="fa fa-inbox icon"></i> <span>Inbox</span></div></router-link>
               <router-link  v-if="auth != ''"  class="inf" to="/account"><div class="container info"><i class="fa fa-user icon"></i> <span>Your account</span></div></router-link>
               <div class="divider"></div>
